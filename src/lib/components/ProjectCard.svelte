...
<article class="card">
	...
	{:else}
		<div class="media" aria-label="Project media">
			<div class="media__frame {project.mediaAspect === 'schematic' ? 'media__frame--schematic' : project.mediaAspect === 'auto' ? 'media__frame--auto' : ''}">
...
<style>
	...
	/* Media section: fixed aspect ratio (383×144) + cover fill, same logic as reference site */
	.media {
		padding: 0.9rem;
		border-bottom: 1px solid var(--border-2);
